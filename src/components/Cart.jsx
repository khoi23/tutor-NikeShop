            ...
            <div
                ...
                <div
                    ...
                    {cartItems?.length === 0 ? (
                        ...
                        <div>
                            <div className="flex items-start justify-start flex-col gap-y-7 lg:gap-y-5 overflow-y-scroll h-[80vh] scroll-smooth bg-scroll ">
                                {cartItems.map((item, i) => (
                                    <CartItem key={i} item={item} />
                                ))}
                            </div>

                            <div className="fixed bottom-0 bg-white w-full px-5 py-4 grid gap-4 items-center">

...
const CartItem = ({
    ...
    return (
        <>
            <div className="flex items-center justify-between w-full px-5 py-0.5 ">
                    ...
                    <div className="grid items-center gap-4">
                        ...
                        <div className="flex items-center justify-around w-full gap-1">
                            <button
                                ...
                                className="bg-theme-cart rounded p-3 lg:p-1 flex items-center justify-center active:scale-90">
                                <MinusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-white stroke-[2]" />
                            </button>
                            <div className="bg-theme-cart rounded text-white font-medium lg:text-xs w-8 h-6 lg:h-7 lg:w-7 flex items-center justify-center">
                                {cartQuantity}
                            </div>
                            <button
                                type="button"
                ...
                <div className="grid items-center gap-5">
                    ...
                    <div className="grid items-center justify-center">
                        <button
                            type="button"
                            className="bg-theme-cart rounded p-3 lg:p-1 grid items-center justify-items-center cursor-pointer"
